...
import { useAuthStore, getRedirectPath, isSuperadmin } from "@/lib/store";
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 flex items-center justify-between border-b border-[var(--border)]">
        <Link href="/superadmin" className="flex items-center gap-3" onClick={onClose}>
      ...
      <div className="p-4 border-t border-[var(--border)]">
        <div className="flex items-center gap-3 px-4 py-3 mb-2">
          <div className="w-10 h-10 rounded-full bg-[var(--secondary)]/10 flex items-center justify-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-[var(--secondary)]">Superadmin</p>
          </div>
        </div>
        <button
          onClick={onLogout}
