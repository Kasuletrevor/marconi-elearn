    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className="font-[family-name:var(--font-display)] text-xl font-semibold text-[var(--foreground)] tracking-tight">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24">
        ...
        >
          ...
          >
            <Link
              href="/login"
              className="group flex items-center gap-2 px-6 py-3 bg-[var(--primary)] text-white font-medium rounded-lg hover:bg-[var(--primary-hover)] transition-all shadow-lg shadow-[var(--primary)]/20"
            >
              Start Teaching
            ...
            <Link
              href="#features"
              className="flex items-center gap-2 px-6 py-3 bg-[var(--card)] text-[var(--foreground)] font-medium rounded-lg border border-[var(--border)] hover:border-[var(--primary)]/30 transition-colors"
            >
              Explore Features
            </Link>
          </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="relative z-10">
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[var(--primary)] font-semibold rounded-xl hover:bg-white/90 transition-colors shadow-xl"
            >
              Get Started Today
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="font-[family-name:var(--font-display)] text-lg font-semibold text-[var(--foreground)]">
              Marconi
            </span>
          </div>
